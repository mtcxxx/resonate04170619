...
def add_freetext_annotation(pdf_path, page_num, position, text):
    ...
    try:
        ...
        # Add FreeText annotation with processed text, red color, and bold formatting
        annot = page.add_freetext_annot(rect, processed_text, fontsize=11, text_color=(1, 0, 0), align=0)
        
        # Set bold formatting by updating the annotation's appearance
        # This requires setting the font to a bold variant
        annot.set_info({"content": processed_text})
        
        # Update the annotation to apply formatting
        annot.update()
        
        # Set border properties
        annot.set_border(width=1, dashes=[2])  # Optional: Add a border
        print(f"DEBUG: Added annotation successfully with red and bold formatting")
...
if __name__ == "__main__":
    try:
        ...
        print("Text will appear in RED and BOLD formatting.")
